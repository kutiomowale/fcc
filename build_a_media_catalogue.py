...
class Movie:
    ...
    def __str__(self):
        return (
            f'{self.title} ({self.year}) - {self.duration}'
            f' min, {self.director}'
        )
...
class TVSeries(Movie):
    ...
    def __init__(
            self, title, year, director, duration, seasons, total_episodes):
    ...
    def __str__(self):
        return (
            ...
            f' {self.total_episodes} episodes, {self.duration}'
            f' min avg, {self.director}'
        )
